...
const Index = () => {
  return (
    <div className="min-h-screen bg-gradient-dark">
      ...
      {/* Vision Section */}
      <section className="py-20 px-4 bg-oxford-white/5 backdrop-blur-sm">
        <div className="container mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 text-left">
              <h2 className="text-3xl md:text-4xl font-bold text-oxford-white">
                Our Vision
              </h2>
              <p className="text-oxford-white/90 text-lg leading-relaxed">
            ...
            <div className="relative animate-fade-in">
              <div className="aspect-square rounded-lg overflow-hidden bg-gradient-to-br from-oxford-blue/20 to-oxford-navy/20 backdrop-blur-sm p-8">
                <img
                  src="/placeholder.svg"
